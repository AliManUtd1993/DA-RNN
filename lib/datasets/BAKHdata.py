# modifying shapenet_scene.py for our dataset
import os
import datasets
import datasets.BAKH
import datasets.imdb
import cPickle
import numpy as np
import cv2

class BAKH(datasets.imdb):
    def __init__(self, image_set, BAKH_path = None):
        datasets.imdb.__init__(self, 'BAKH_' + image_set)
        self._image_set = image_set
        self._BAKH_path = self._get_default_path() if BAKH_path is None \
                            else BAKH_path
        self._data_path = os.path.join(self._BAKH_path, 'data')
        self._classes = ('__background__', 'NV Peanut Butter', 'NV S&S Almond', 'NV S&S Cashew', 'NV Square CBS', 'Windex', \
        'Tapatio Sauce', 'Redbull','Clif Peanut Butter', 'Clif Crunch Chocolate','VO5 Shampoo' \
        , 'Clif White','Coca Cola', 'Red Cup','Paper Plate', 'Aunt Jemima Syrup')
        ################################## REMEMBER TO CHANGE COLORS
        self._class_colors = [(0, 0, 0), (255, 0, 0), (0, 255, 0), (0, 0, 255), (255, 255, 0), (255, 0, 255),\
        (0, 255, 255), (188, 0, 0),(0, 0, 0), (255, 0, 0), (0, 255, 0), (0, 0, 255), (255, 255, 0), (255, 0, 255),\
        (255, 255, 0), (255, 0, 255)]
        ...
        assert os.path.exists(self._BAKH_path), \
                'BAKH path does not exist: {}'.format(self._BAKH_path)
    ...
    def _load_image_set_index(self):
        ...
        """
        image_set_file = os.path.join(self._BAKH_path, self._image_set + '.txt')
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(datasets.ROOT_DIR, 'data', 'BAKH')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_BAKH_annotation(index)
    ...
    def _load_BAKH_annotation(self, index):
        """
